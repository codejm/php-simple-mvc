...
class Cache_Memcache {
    ...
    function get($key) {
        ...
        //return $this->memcached ? $this->cache->getMulti($key) : $this->cache->get($key, $this->compress);
    }

    function set($key,$value,$expire=0) {
        return $this->memcached ? $this->cache->set($key,$value,$expire) : $this->cache->set($key,$value,$expire);;
        //return $this->memcached ? $this->cache->set($key,$value,$expire) : $this->cache->set($key,$value,$this->compress,$expire);;
    }
